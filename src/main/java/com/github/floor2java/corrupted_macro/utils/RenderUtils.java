...
import static com.github.floor2java.corrupted_macro.utils.DrawUtils.*;
...
public class RenderUtils {
    ...
    public static Color rainbow(int delay) {
        float v1 = 1f;//(float) DelClient.settingsManager.getSettingById("module_list_bg_rainbow_1").getValDouble();
        float v2 = 1f;//(float) DelClient.settingsManager.getSettingById("module_list_bg_rainbow_2").getValDouble();
