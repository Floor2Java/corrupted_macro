package com.github.floor2java.corrupted_macro.utils.gui.glyph;
...
public class GlyphPageFontRenderer {
    ...
    public static GlyphPageFontRenderer createWithTTF(String fontName, int size, boolean bold, boolean italic, boolean boldItalic) {
        ...
        try {
            InputStream is = GlyphPageFontRenderer.class.getResourceAsStream("/assets/minecraft/fonts/" + fontName);
        ...
        if (bold) {
            ...
            boldPage = new GlyphPage(boldFont, true, true);
        ...
        if (italic) {
            ...
            italicPage = new GlyphPage(italicFont, true, true);
        ...
        if (boldItalic) {
            ...
            boldItalicPage = new GlyphPage(boldItalicFont, true, true);
    ...
    public int drawCenteredString(String text, float x, float y, int color, boolean dropShadow) {
        ...
        if (dropShadow) {
            i = this.renderString(text, centeredX + 1.0F, y + 1.0F, color, true);
            i = Math.max(i, this.renderString(text, centeredX, y, color, false));
        } else {
            i = this.renderString(text, centeredX, y, color, false);
        }
