package com.github.floor2java.corrupted_macro.utils.gui.shaders.misc;

import com.github.floor2java.corrupted_macro.CorruptedBanana;
...
public class Shader{
    ...
    public static String getShaderSource(String fileName) {
        String source = "";
        try (BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(CorruptedBanana.class.getResourceAsStream("/assets/minecraft/shaders/" + fileName)))) {
